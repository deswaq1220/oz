...
(function(w) {
    ...
    try {
        var links = ["https:\/\/mat.adpies.com\/mat\/init?oaid=c83193351d52db3705c9844f51e81456\u0026landing=https%3A%2F%2Fastg.widerplanet.com%2Fdelivery%2Fwpp.php%3Fwpg%3Dadpies_rtb%26oaid%3Dc83193351d52db3705c9844f51e81456","https:\/\/cm.g.doubleclick.net\/pixel?google_nid=wider_planet\u0026google_cm\u0026google_ula=12153253,1702608573\u0026poaid=c83193351d52db3705c9844f51e81456","https:\/\/cm-exchange.toast.com\/bi\/pixel?cm_pid=1107948209\u0026puid=c83193351d52db3705c9844f51e81456\u0026toast_push"],
            len = links.length,
            i;
        for (i=0; i<len; i++) {
            doPair(links[i]);
...
(function() {
var ttd = new Image();
ttd.src = "https:\/\/match.adsrvr.org\/track\/cmf\/generic?ttd_pid=ven6wdk\u0026ttd_tpi=1\u0026ttd_puid=c83193351d52db3705c9844f51e81456";
})();
/*]]>*/
...
(function(w) {
    try {
        ...
        if (wp_uid) {
            ...
            if (is_wp_uid) {
                identity.setCookie('_wp_uid', "2-c83193351d52db3705c9844f51e81456-s1655777149.135042|mac_osx|chrome-1q6ffn5", 365);
                return;
            }
        }
